#ifndef RECEIPTIONWINDOW_H
#define RECEIPTIONWINDOW_H
...
namespace Ui {
class ReceiptionWindow;
}

class ReceiptionWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit ReceiptionWindow(int loginID, QWidget *parent = nullptr);
    ~ReceiptionWindow();
